...
export class InternmentOrderService {
	...
	create(patientId: number, prescriptionDto: PrescriptionDto): Observable<number[]> {
		const url = `${environment.apiBase}/institutions/${this.contextService.institutionId}/internment-service-request/patient/${patientId}/`;
