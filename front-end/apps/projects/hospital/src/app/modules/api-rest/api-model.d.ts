...
export const enum AppFeature {
    ...
    HABILITAR_SIP_PLUS_EN_DESARROLLO = "HABILITAR_SIP_PLUS_EN_DESARROLLO",
    ...
    HABILITAR_OTRAS_CIRCUNSTANCIAS_EPICRISIS = "HABILITAR_OTRAS_CIRCUNSTANCIAS_EPICRISIS",
    HABILITAR_MODULO_AUDITORIA = "HABILITAR_MODULO_AUDITORIA",
    HABILITAR_CAUSA_EXTERNA_EPICRISIS = "HABILITAR_CAUSA_EXTERNA_EPICRISIS",
}
