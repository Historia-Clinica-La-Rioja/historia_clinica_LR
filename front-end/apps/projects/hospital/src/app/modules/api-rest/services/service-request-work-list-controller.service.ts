...
export class ServiceRequestWorkListControllerService {
	...
	getList(categories: string[], pageNumber: number, pageSize: number, studyOrderWorkListFilterDto:StudyOrderWorkListFilterDto): Observable<PageDto<StudyOrderWorkListDto[]>> {
		let params: HttpParams = new HttpParams()
			.set('pageNumber', pageNumber)
			.set('pageSize', pageSize)
			.set('categories', categories.join(','))
			.set('filter', JSON.stringify(studyOrderWorkListFilterDto));
