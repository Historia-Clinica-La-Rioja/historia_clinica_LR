	...
	search(formDirectiveSearchForm: FormGroupDirective): void {
		...
		if (this.formSearch.valid) {
			...
			const searchRequest = {
				...
				identificationNumber: this.formSearch.controls.identifType.value === IDENTIFICATION_TYPE_IDS.DNI ? +this.formSearch.controls.identifNumber.value.toString().replaceAll(/\W/g,'') : +this.formSearch.controls.identifNumber.value,
