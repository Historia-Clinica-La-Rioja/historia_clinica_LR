...
const routes: Routes = [
	{
		...
		data: {
			...
			ERole.ADMINISTRATIVO_RED_DE_IMAGENES, ERole.ADMINISTRADOR_INSTITUCIONAL_PRESCRIPTOR, ERole.PRESCRIPTOR, ERole.AUDITOR_MPI, ERole.TECNICO, ERole.PERSONAL_DE_LEGALES]
		},
