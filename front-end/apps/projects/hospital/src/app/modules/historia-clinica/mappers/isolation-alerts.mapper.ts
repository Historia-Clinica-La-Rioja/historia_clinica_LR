import { MasterDataDto, PatientCurrentIsolationAlertDto, UpdateIsolationAlertDto } from "@api-rest/api-model"
import { convertDateTimeDtoToDate, dateDtoToDate, dateToDateDto, } from "@api-rest/mapper/date-dto.mapper"
...
import { toClinicalTermDto } from "./emergency-care-evolution-note.mapper"
...
export const toIsolationAlert = (isolationAlert: PatientCurrentIsolationAlertDto): IsolationAlert => {
	return {
		id: isolationAlert.isolationAlertId,
		statusId: isolationAlert.status.id,
		diagnosis: toClinicalTermDto(null, isolationAlert.healthConditionPt, isolationAlert.healthConditionSctid),
...
export const toUpdateIsolationAlertDto = (isolationAlert: IsolationAlert): UpdateIsolationAlertDto => {
	return {
		criticalityId: isolationAlert.criticality.id,
