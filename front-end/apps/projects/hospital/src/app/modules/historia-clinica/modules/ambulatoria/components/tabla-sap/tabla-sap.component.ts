...
const IMAGE_ITEM = "../../../../../assets/tabla-sap/";
...
@Component({
  selector: 'app-tabla-sap',
  templateUrl: './tabla-sap.component.html',
  styleUrls: ['./tabla-sap.component.scss']
})
export class TablaSapComponent implements OnInit {
