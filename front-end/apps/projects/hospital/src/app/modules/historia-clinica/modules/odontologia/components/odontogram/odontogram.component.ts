...
export class OdontogramComponent implements OnInit {
	...
	dataSource: PeriodicElement[] = [
		...
		{grafic: IMAGE_BASE_PATH + '20.png', name: 'Perno', weight: 'Ausencia dental', symbol: 'Perno pasante/Perno muñón'},
		{grafic: IMAGE_BASE_PATH + '21.png', name: 'Surco oclusal', weight: 'Sellador de fosas, surcos y fisuras', symbol: 'Surco oclusal profundo'},
		{grafic: IMAGE_BASE_PATH + '22.png', name: 'Sellador', weight: 'Surco oclusal', symbol: 'Sellador fosas, surcos y fisuras'},
	];
