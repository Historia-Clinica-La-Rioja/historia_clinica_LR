...
import { AnthropometricData, IsolationAlertDescriptionItemData, ReferredDescriptionItemData, VitalSignsAndRiskFactorsData } from '@historia-clinica/utils/document-summary.model';
...
export class EvolutionNoteSummaryService {
    ...
    mapEvolutionNoteAsViewFormat(evolutionNote: EmergencyCareEvolutionNoteDocumentDto): EvolutionNoteAsViewFormat {
        return {
            ...
            ...(evolutionNote.emergencyCareEvolutionNoteClinicalData.isolationAlerts &&
                { isolationAlerts: this.documentsSummaryService.mapIsolationAlertDescriptionItemDataList(evolutionNote.emergencyCareEvolutionNoteClinicalData.isolationAlerts) }),
        }
    }
}
...
export interface EvolutionNoteAsViewFormat {
    ...
    isolationAlerts: IsolationAlertDescriptionItemData[],
}
