...
export class NewViolentPersonInfomationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = new FormGroup({
      ...
      hasAfirearm: new FormControl(null, Validators.required),
      hasBeenTreated: new FormControl(null, Validators.required),
      belongsToSecurityForces: new FormControl(null, Validators.required),
