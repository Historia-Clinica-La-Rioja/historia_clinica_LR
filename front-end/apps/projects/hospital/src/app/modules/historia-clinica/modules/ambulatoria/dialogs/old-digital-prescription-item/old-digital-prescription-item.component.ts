...
const PRESENTATION: string[] = ["óvulo", "cápsula", "comprimido", "supositorio"];
@Component({
	selector: 'app-old-digital-prescription-item',
	templateUrl: './old-digital-prescription-item.component.html',
	styleUrls: ['./old-digital-prescription-item.component.scss']
})
export class OldDigitalPrescriptionItemComponent implements OnInit {
	...
	pharmaceuticalForm: string[] = PRESENTATION;
	...
	constructor(@Inject(MAT_DIALOG_DATA) public data,
				...
				private readonly dialogRef: MatDialogRef<OldDigitalPrescriptionItemComponent>,
