...
@Component({
  selector: 'app-anexos-ii',
  templateUrl: './anexos-ii.component.html',
  styleUrls: ['./anexos-ii.component.scss']
})
export class AnexosIIComponent implements OnInit {
	...
	constructor(
		private readonly dialogRef: MatDialogRef<AnexosIIComponent>,
