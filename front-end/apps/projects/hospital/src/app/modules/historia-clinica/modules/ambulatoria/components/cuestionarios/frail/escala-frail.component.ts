...
@Component({
  selector: 'app-escala-frail',
  templateUrl: './escala-frail.component.html',
  styleUrls: ['./escala-frail.component.scss'],
})
export class EscalaFrailComponent implements OnInit {
