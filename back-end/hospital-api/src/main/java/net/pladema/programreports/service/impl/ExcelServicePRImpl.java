...
public class ExcelServicePRImpl implements ExcelServicePR {
	...
	@Override
	public IWorkbook buildExcelRecuperoSumar(String tittle, String[] headers, List<ConsultationDetailRecuperoSumar> result) {
		IWorkbook wb = WorkbookCreator.createExcelWorkbook();
		createCellStyle(wb);

		for (ConsultationDetailRecuperoSumar imc : result) {
			...
			if (peso != null && altura != null) {
				...
				ConsultationDetailRecuperoSumar consultationDetailRecuperoSumar = new ConsultationDetailRecuperoSumar(imcFormat);
	...
	@Override
	public IWorkbook buildExcelOdontologia(String tittle, String[] headers, List<ConsultationDetailOdontologia> result) {
		IWorkbook wb = WorkbookCreator.createExcelWorkbook();
		createCellStyle(wb);
	...
	@Override
	public IWorkbook buildExcelOdontologiaRecupero(String tittle, String[] headers, List<ConsultationDetailRecuperoOdontologia> result) {
		IWorkbook wb = WorkbookCreator.createExcelWorkbook();
		createCellStyle(wb);
		...
		result.forEach(
				resultData -> {
					IRow newDataRow = sheet.createRow(rowNumber.get());
					fillRowContent(newDataRow, resultData, styleDataRow);
				}
		);
	...
	private void fillRowContent(IRow row, ConsultationDetailRecuperoSumar content, ICellStyle style) {
		AtomicInteger rowNumber = new AtomicInteger(0);
	...
	private void fillRowContent(IRow row, ConsultationDetailRecuperoOdontologia content, ICellStyle style) {
		AtomicInteger rowNumber = new AtomicInteger(0);
		...
		ICell cell3 = row.createCell(rowNumber.getAndIncrement());
		cell3.setCellValue(content.getIdentificationNumber());
		cell3.setCellStyle(style);
		...
		ICell cell6 = row.createCell(rowNumber.getAndIncrement());
		cell6.setCellValue(content.getPatientIdentificationNumber());
		cell6.setCellStyle(style);
		...
		ICell cell12 = row.createCell(rowNumber.getAndIncrement());
		cell12.setCellValue(content.getAddress());
		cell12.setCellStyle(style);
		...
		ICell cell14 = row.createCell(rowNumber.getAndIncrement());
		cell14.setCellValue(content.getCpo());
		cell14.setCellStyle(style);

		ICell cell15 = row.createCell(rowNumber.getAndIncrement());
		cell15.setCellValue(content.getCeo());
		cell15.setCellStyle(style);
		...
		ICell cell18 = row.createCell(rowNumber.getAndIncrement());
		cell18.setCellValue(content.getOdontologyProcedures());
		cell18.setCellStyle(style);
		...
		ICell cell20 = row.createCell(rowNumber.getAndIncrement());
		cell20.setCellValue(content.getOdontologyDiagnosis());
		cell20.setCellStyle(style);
	}
