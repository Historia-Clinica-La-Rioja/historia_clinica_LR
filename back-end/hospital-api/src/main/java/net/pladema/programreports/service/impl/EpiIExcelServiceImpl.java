...
@Service
public class EpiIExcelServiceImpl implements ExcelServiceEpidemiologiaI {
	...
	@Override
	public IWorkbook buildExcelFromQuery(String tittle, String[] headers, List<ConsultationDetailEpiI> result) {
