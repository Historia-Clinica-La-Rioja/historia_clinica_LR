...
public class ProgramReportsController {
	...
	public ProgramReportsController(ExcelServiceEpiI excelServiceEpiI, ExcelServiceEpiII excelServiceEpiII, QueryFactoryPR queryFactoryPR, LocalDateMapper localDateMapper) {
