...
public class NewMedicationRequestTemplateInput extends NotificationTemplateInput<NewMedicationRequestNotificationArgs> {
	...
	public NewMedicationRequestTemplateInput(NewMedicationRequestNotificationArgs args) {
		super(TEMPLATE_ID, args, AppFeature.HABILITAR_RECETA_DIGITAL, args.getResources());
	}
}