...
import net.pladema.clinichistory.generalstate.service.domain.HCEClinicalObservationBo;
import net.pladema.clinichistory.generalstate.service.domain.HCEVitalSignBo;
