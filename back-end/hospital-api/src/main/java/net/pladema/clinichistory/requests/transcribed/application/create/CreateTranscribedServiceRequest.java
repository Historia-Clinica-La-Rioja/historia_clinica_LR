package net.pladema.clinichistory.requests.transcribed.application.create;
...
import net.pladema.clinichistory.requests.transcribed.infrastructure.output.repository.entity.TranscribedServiceRequest;
...
@Service
public class CreateTranscribedServiceRequest {
	...
	@Transactional
    public Integer run(TranscribedServiceRequestBo transcribedServiceRequestBo) {
	...
	private HealthCondition buildBasicHealthCondition(TranscribedServiceRequestBo transcribedServiceRequestBo) {
		...
		healthCondition.setStartDate(LocalDate.now());
