package net.pladema.clinichistory.requests.transcribed.infrastructure.input.rest.exceptions;
...
@RestControllerAdvice(basePackages = "net.pladema.clinichistory.requests.transcribed")
public class TranscribedServiceRequestExceptionHandler {
