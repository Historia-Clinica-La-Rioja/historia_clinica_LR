...
import net.pladema.clinichistory.documents.service.hce.domain.HCEClinicalObservationBo;
import net.pladema.clinichistory.documents.service.hce.domain.HCEVitalSignBo;
