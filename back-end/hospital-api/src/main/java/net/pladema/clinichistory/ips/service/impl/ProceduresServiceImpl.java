...
import net.pladema.clinichistory.ips.repository.ProceduresRepository;
import net.pladema.clinichistory.ips.repository.entity.Procedure;
import net.pladema.clinichistory.ips.repository.masterdata.ProceduresStatusRepository;
import net.pladema.clinichistory.ips.repository.masterdata.entity.ProceduresStatus;
import net.pladema.clinichistory.ips.service.ProceduresService;
