...
@Service
public class BackofficeClinicalServiceStore implements BackofficeStore<ClinicalSpecialty, Integer> {

	private final ClinicalSpecialtyRepository repository;

	public BackofficeClinicalServiceStore(ClinicalSpecialtyRepository repository){
		super();
	...
	public Page<ClinicalSpecialty> findAll(ClinicalSpecialty clinicalSpecialty, Pageable pageable) {
		clinicalSpecialty.setClinicalSpecialtyTypeId(ClinicalSpecialtyType.Service);
	...
	public List<ClinicalSpecialty> findAll() {
		...
		specialties.setClinicalSpecialtyTypeId(ClinicalSpecialtyType.Service);
