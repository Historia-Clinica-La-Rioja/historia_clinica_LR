...
@Slf4j
@AllArgsConstructor
public class GetAllProfessionalsAndTechnicians {

	private final HealthcareProfessionalRepository healthcareProfessionalRepository;

	public List<HealthcareProfessionalBo> run() {
		log.debug("No input parameters");
		List<Short> professionalERoleIds = getRolesId() ;
		List<HealthcareProfessionalVo> queryResults = healthcareProfessionalRepository.findAllByRoleIds(professionalERoleIds);
