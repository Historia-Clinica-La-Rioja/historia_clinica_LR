...
public class TranscribedEquipmentAppointmentValidator implements ConstraintValidator<ValidTranscribedEquipmentAppointment, Object[]> {

	private static final Logger LOG = LoggerFactory.getLogger(TranscribedEquipmentAppointmentValidator.class);
    ...
    @Override
    public void initialize(ValidTranscribedEquipmentAppointment constraintAnnotation) {
        // nothing to do
    }
	...
	public boolean isValid(Object[] parameters, ConstraintValidatorContext context) {
		...
		CreateAppointmentDto createAppointmentDto = (CreateAppointmentDto) parameters[2];
