...
@AllArgsConstructor
@NoArgsConstructor
public class ProcedureParameterVo {
	...
	public ProcedureParameterVo(Integer id, Integer procedureTemplateId, Integer loincId, Short typeId, Short orderNumber, Short inputCount, Integer snomedGroupId) {
		this.id = id;
