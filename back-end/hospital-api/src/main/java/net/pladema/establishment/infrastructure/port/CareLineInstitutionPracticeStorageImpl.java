...
@Service
public class CareLineInstitutionPracticeStorageImpl implements CareLineInstitutionPracticeStorage {
	...
	@Override
	public List<SnomedBo> fetchPracticesByCareLineId(Integer careLineId) {
		log.debug("Fetch all practices by care line with id {}", careLineId);
		return careLineInstitutionPracticeRepository.getPracticesByCareLineId(careLineId);
	}
