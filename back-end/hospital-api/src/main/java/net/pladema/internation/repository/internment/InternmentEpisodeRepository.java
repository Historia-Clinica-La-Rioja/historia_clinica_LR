package net.pladema.internation.repository.internment;
...
public interface InternmentEpisodeRepository extends JpaRepository<InternmentEpisode, Integer> {
    ...
    @Query("SELECT NEW net.pladema.internation.repository.internment.domain.summary.InternmentSummaryVo(" +
            "ie.id,  ie.entryDate, " +
    ...
    @Query("SELECT NEW net.pladema.internation.service.internment.domain.InternmentEpisodeBo(" +
            ...
            "     ) " +
            "AND pd.internmentEpisodeId IS NULL " +
