...
import net.pladema.internation.repository.documents.entity.EvolutionNoteDocumentPK;
...
public interface EvolutionNoteDocumentRepository extends JpaRepository<EvolutionNoteDocument, EvolutionNoteDocumentPK> {
    ...
    @Query("SELECT NEW net.pladema.internation.repository.internment.domain.summary.EvaluationNoteSummaryVo(d.id, d.statusId) " +
