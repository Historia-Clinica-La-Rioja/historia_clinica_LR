...
public class GetFrailPDFController implements GetFrailPDFAPI {
	...
	private final PrintQuestionnaireService printQuestionnaireService;
	private final PdfService pdfService;


	public GetFrailPDFController(PrintQuestionnaireService printQuestionnaireService, PdfService pdfService) {
