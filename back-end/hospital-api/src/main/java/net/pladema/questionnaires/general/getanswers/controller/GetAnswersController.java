...
public class GetAnswersController {
	...
	@PostMapping("institution/{institutionId}/questionnaire/{responseId}/answers")
	public ResponseEntity<List<AnswerDTO>> getAnswersForResponse (
		@PathVariable Integer institutionId, @PathVariable Integer responseId
	) {
		List<AnswerDTO> answers = answersService.getAnswersForResponse(responseId);
