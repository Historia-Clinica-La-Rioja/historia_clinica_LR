...
public class SnowstormCie10RefsetMembersResponse {

    private List<SnowstormCie10ItemResponse> items;
    ...
    public SnowstormCie10RefsetMembersResponse(@JsonProperty("items") List<SnowstormCie10ItemResponse> items,
