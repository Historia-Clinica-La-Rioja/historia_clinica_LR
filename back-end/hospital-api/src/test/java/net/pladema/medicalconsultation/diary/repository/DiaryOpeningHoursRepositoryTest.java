...
class DiaryOpeningHoursRepositoryTest extends UnitRepository {
	...
	void test_active_diaries_from_professional() {
		...
		save(new DiaryOpeningHours(diary1.getId(), oh1.getId(), MedicalAttentionType.PROGRAMMED, (short) 1, false, false ));


		from = "14:00";
		to = "18:00";
		OpeningHours oh2 = save(new OpeningHours((short)1, LocalTime.parse(from, timeFormatter), LocalTime.parse(to, timeFormatter)));
		save(new DiaryOpeningHours(diary1.getId(), oh2.getId(), MedicalAttentionType.SPONTANEOUS, (short) 4 , false, false));
		...
		save(new DiaryOpeningHours(diary2.getId(), oh3.getId(), MedicalAttentionType.PROGRAMMED, (short) 1, false, false ));

		from = "14:00";
		to = "18:00";
		OpeningHours oh4 = save(new OpeningHours((short)1, LocalTime.parse(from, timeFormatter), LocalTime.parse(to, timeFormatter)));
		save(new DiaryOpeningHours(diary2.getId(), oh4.getId(), MedicalAttentionType.SPONTANEOUS, (short) 4, false, false));
