...
class DailyAppointmentRepositoryTest extends UnitRepository {
    ...
    void test_getDailyAppointmentsByDiaryIdAndDate_success(){
        ...
        save(new DiaryOpeningHours(diaryId, ohProgrammed.getId(), MedicalAttentionType.PROGRAMMED, (short) 10, false, false));
        save(new DiaryOpeningHours(diaryId, ohSpontaneous.getId(), MedicalAttentionType.SPONTANEOUS, (short) 0, false, false));
