...
@Slf4j
public class SearchCachedConceptsWithResultCount {
    ...
    public SnomedSearchBo run(String term, String eclKey) {
        ...
        SnomedSearchVo searchResult = snomedConceptsRepository.searchConceptsWithResultCountByEcl(term, ecl, eclKey);
