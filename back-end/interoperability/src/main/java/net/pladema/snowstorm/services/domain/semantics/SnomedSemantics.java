...
public class SnomedSemantics {
	...
	@Value("${snomed-semantics.eventGroup.ecl}")
	@ToString.Include
	private String eventGroupEcl;
    
	@Value("${snomed-semantics.medicineWithUnitOfPresentation.ecl}")
	@ToString.Include
	...
	@Value("${snomed-semantics.hypertensionGroup.ecl}")
	@ToString.Include
	...
	@Value("${snomed-semantics.electrocardiographicProcedureGroup.ecl}")
	@ToString.Include
