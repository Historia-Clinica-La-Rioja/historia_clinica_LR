...
import net.pladema.medication.domain.commercialMedicationArticle.ATCList;
import net.pladema.medication.domain.commercialMedicationArticle.BarCodeList;
import net.pladema.medication.domain.commercialMedicationArticle.GTINList;
import net.pladema.medication.domain.commercialMedicationArticle.NewDrugList;
