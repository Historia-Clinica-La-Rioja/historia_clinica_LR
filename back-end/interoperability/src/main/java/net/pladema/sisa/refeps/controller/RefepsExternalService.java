...
public interface RefepsExternalService {
	...
	List<ValidatedLicenseDataDto> validateLicenseNumberAndType(String identificationNumber, List<LicenseDataDto> licenseData) throws RefepsApiException, RefepsLicenseException;
