...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "action", schema = "commercial_medication")
@Entity
public class CommercialMedicationAction implements Serializable {
	...
	public CommercialMedicationAction(CommercialMedicationMasterData action) {
