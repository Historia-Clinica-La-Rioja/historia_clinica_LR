...
import commercialmedication.cache.configuration.CommercialMedicationSoapRestTemplate;

import commercialmedication.cache.domain.decodedResponse.CommercialMedicationDecodedResponse;
import commercialmedication.cache.domain.CommercialMedicationRequestEnvelope;

import commercialmedication.cache.domain.CommercialMedicationRequestParameter;

import commercialmedication.cache.domain.CommercialMedicationResponseEnvelope;
