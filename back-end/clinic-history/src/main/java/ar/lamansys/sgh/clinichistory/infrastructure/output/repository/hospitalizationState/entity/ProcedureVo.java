...
public class ProcedureVo extends ClinicalTermVo {
	...
	public ProcedureVo(Integer id, Snomed snomed, String statusId, LocalDate performedDate, Boolean isPrimary, String note) {
		this(id, snomed, statusId, performedDate);
