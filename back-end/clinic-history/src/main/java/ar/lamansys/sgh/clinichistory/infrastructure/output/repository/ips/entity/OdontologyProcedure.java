...
@Entity
@Table(name = "odontology_procedure")
@EntityListeners(SGXAuditListener.class)
@Getter
@Setter
@ToString
@NoArgsConstructor
public class OdontologyProcedure extends SGXAuditableEntity<Integer> implements SGXDocumentEntity {
    ...
    public boolean equals(Object o) {
        ...
        OdontologyProcedure that = (OdontologyProcedure) o;
