...
class UpdateUsernameAndPasswordTest {
    ...
    @BeforeEach
    public void setUp() {
        updateUsernameAndPassword = new UpdateUsernameAndPassword(userStorage, passwordResetTokenStorage, updateUserPassword, oAuthUserManagementStorage);
    }
    ...
    void resetPasswordSuccess() {
        ...
        updateUsernameAndPassword.run("token","username", "password");
